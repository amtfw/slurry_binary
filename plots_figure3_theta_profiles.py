...
sd ='sd_nz_512_theta_0p04_Pr_0p1_St_4_D_0p1_K_100_alpha_0p05_beta_0p005_la_1_lb_1_lr_1p1_lc_1_lk_1_lm_10000_chi_1p38_ax_1p1_tau_0p001_xc_0p001_B_3000_ds'
...
par_name = 'theta'
par_values = [0.038, 0.039, 0.04, 0.041, 0.042, 0.043, 0.044]
...
VAR_LIST = ['Xi','fS',  'uS', 'uL','rho', 'rhoL', 'rhoS', 'J_Xi']
TITLE_LIST = ['\\xi^l','\phi^s',  'u_z^s', 'u_z^l', '\\bar{\\rho}', '\\rho^l', '\\rho^s', 'j_\\xi' ]
...
fig_string = 'figure3_theta_profiles'
